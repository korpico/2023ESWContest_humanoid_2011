...
연속전진_골프_1:
    ...
    보행COUNT = 보행COUNT + 1
    IF 보행COUNT > 보행횟수 THEN  GOTO 연속전진_골프_정지
...
연속후진_골프_1:
    ...
    '보행COUNT = 보행COUNT + 1
    'IF 보행COUNT > 보행횟수 THEN  GOTO 연속후진_골프_1_EXIT
...
연속후진_골프_2:
    ...
    '보행COUNT = 보행COUNT + 1
    'IF 보행COUNT > 보행횟수 THEN  GOTO 연속후진_골프_2_EXIT
...
골프_준비_자세:
    GOSUB 왼쪽옆으로 10_골프
    DELAY 500 'DELAY 시간 변경하면서 걸음수 조절?
    GOSUB 오른쪽턴 45_골프
    DELAY 50
    GOSUB 왼쪽옆으로 10_골프
    DELAY 50
