...
def flag_detect(frame, cnts, now_color):
    ...
    return left_flag_exist, right_flag_exist, front_flag_exist

#**************************************************
def flag_adjust(frame, cnts, now_color, ball_count):
    ball = ball_count + 1
    flag_adjusting = 1
    return ball, flag_adjusting
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if (ball_detection_area == 0):
            ...
            left_flag_exist, right_flag_exist, front_flag_exist = flag_detect(frame, cnts, now_color)
